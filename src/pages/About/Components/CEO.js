...
const CEO = () => {
  return (
    <div className="my-16">
      ...
      ></div>
      <p className="text-sm px-3 font-semibold text-center max-w-2xl mx-auto mt-5">
      ...
      <section className="container mx-auto">
        {/* first */}
        <div
          className={`md:flex items-center space-x-5 md:p-4 mt-7 transition-all ease-in duration-1000`}
        >
          <div className="md:basis-1/3 flex relative">
            <img src={first} alt="" className=" md:p-5 rounded-lg bg-white" />
          </div>
        ...
        {/* second */}
        <div
          className={`md:flex items-center my-10  transition-all ease-in duration-1000`}
        >
          <div className="basis-1/2 order-2 flex justify-center mt-5 mb-5 md:mb-0 px-3 md-px-0">
            <img src={second} alt="" />
          </div>
          <div className="basis-1/2 order-1 px-3 text-right flex  justify-center md:justify-end">
            <div className=" md:px-0">
              <h1 className="md:text-[2rem] lg:text-[3rem] text-[1.5rem] font-semibold md:pt-5">
                Rate your experence
              </h1>
        ...
        {/* fourth */}
        <div
          className={`md:flex items-center my-10 space-x-5 transition-all ease-in duration-1000`}
        >
          <div className="basis-1/3 order-2 mb-5 md:mb-0 flex justify-end">
            <img src={fourth} alt="" />
          </div>
          <div className="basis-2/3 order-1 flex px-3 justify-center md:justify-end text-right">
            <div className=" md:px-0">
              <h1 className="md:text-[2rem] lg:text-[3rem] text-[1.5rem] font-semibold md:pt-5">
