  ...
  return (
    <div className="flex bg-white h-screen">
      <div class="w-full p-8  lg:w-1/2">
        ...
        {/* start */}
        <div className="max-w-lg h-full flex items-center mx-auto my-auto">
          <div className="grow">
            <p class="text-2xl font-bold tracking-wide  text-center">
              Welcome{" "}
            </p>
                  ...
                  <div>
                    <label for="remember" class="">
                      <input
                        type="checkbox"
                        id="remember"
                        class="w-4 h-4 mr-2 border-slate-200 focus:bg-indigo-600"
                      />
                      Remember me
                    </label>
                  </div>
                  <div>
                    <a href="#" class="font-medium text-[#ff674d]">
                      Forgot Password?
                    </a>
                  </div>
                </div>
                <button class="w-full py-3 font-medium text-white bg-[#ff674d] hover:bg-[#ff674d] rounded-lg border-[#ff674d] hover:shadow inline-flex space-x-2 items-center justify-center">
                  <svg
      ...
      >
        <div
          className={`h-full object-cover login`}
